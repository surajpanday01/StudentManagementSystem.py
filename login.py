...
def login():
     if usernameEntry.get()=='' or passwordEntry.get()=='':
         messagebox.showerror('Error','Fields cn not be empty')


     elif usernameEntry.get() == 'suraj' or passwordEntry.get() == '1234@':
         messagebox.showinfo('Success','Welcome')
         window.destroy()
         import sms

     else:
         messagebox.showerror('Error', ' Please enter correct credential')
...
logoImage=PhotoImage(file='who.png')
